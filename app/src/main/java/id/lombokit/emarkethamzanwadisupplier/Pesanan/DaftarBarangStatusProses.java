 ...
 */
public class DaftarBarangStatusProses extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    Url_root root = new Url_root();
    String slug_viewProduct = "view_product_status_proses.php";
    ...
    public DaftarBarangStatusProses() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_daftar_barang_status_proses, container, false);
    ...
    public class Recycle_adapterStatusTunda extends RecyclerView.Adapter<Recycle_adapterStatusTunda.My_viewHolder> {
        ...
        public void onBindViewHolder(@NonNull final Recycle_adapterStatusTunda.My_viewHolder holder, final int position) {
            ...
            if (parse == 1) {
                ...
                holder.radioButtonProses.setVisibility(View.GONE);
                holder.layout_yellow.setVisibility(View.VISIBLE);
            ...
            holder.radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    switch (checkedId) {
                        case R.id.selesaikan:
                            getActivity().finish();
                            getActivity().overridePendingTransition(0, 0);
                            getActivity().startActivity(getActivity().getIntent());
                            getActivity().overridePendingTransition(0, 0);
                            update_status(categories.getProductsArrayList().get(position).getId_barang());
                            push_notifikasi("Pesanan anda terselesaikan", categories.getProductsArrayList().get(position).getToken());
                        case R.id.tolak:
    ...
    private void update_status(final int id_barang) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url_update_status, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("pembanding",String.valueOf(1));
